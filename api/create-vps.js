...
const ALLOWED_ORIGIN_PATTERN = /^https?:\/\/([\w\-]+\.)?(hieuvn\.xyz|zephyrcloud\.vercel\.app)(\/.)?$/;
  ...
  deploy:
    ...
    - name: 🖥️ Cài đặt và chạy TightVNC, noVNC, Cloudflared
      ...
      run: |
        ...
        Write-Host "🌌 Access noVNC via remote-link.txt URL (Password: phongdz)"
...
4. Open the URL in browser and use password: **phongdz**
## ⚡ Features
    ...
    try {
      await octokit.rest.repos.createDispatchEvent({
        ...
        client_payload: {
          ...
          backup: true,
          created_by: 'phongdz-vps-manager'
        }
      });
